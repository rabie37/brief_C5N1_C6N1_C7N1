...
if (isset($_POST["submit"])) {
  ...
  $sql = 'INSERT INTO customer(cs_id,cs_fname,cs_lname,cs_minit,cs_address	) VALUES(:id,:cs_fname,:cs_lname,:cs_minit,:cs_address)';
...
<div class="nav">
    ...
    <a class="logout" href="../INCLUD/logout.php">logout</a>
            ...
            <form class="animaly">
<button class="add"  type="submit" formaction="customers.php">Back</button>
