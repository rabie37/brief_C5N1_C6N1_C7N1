...
if (isset($_POST["submit"])) {
  ...
  $cost = $_POST["cost"];
    ...
    $sql = 'UPDATE birds SET petcategory=:category, type=:type , noise=:noise, cost=:cost WHERE pet_id=:id';
...
<div class="nav">
    ...
    <a class="logout" href="../INCLUD/logout.php">logout</a>
            ...
            <form class="animaly">
<button class="add"  type="submit" formaction="birds.php">Back</button>
